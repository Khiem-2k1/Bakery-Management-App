...
namespace TheCoffee
{
    public partial class GioHangView : UserControl
    {
        ...
        public void LoadData()
        {
            ...
            lblName.Text = user.us_firstname + "" + user.us_lastname;
            lblPhone.Text = user.us_phone;
            lblAddress.Text = user.us_address;
            lblEmail.Text = user.us_email;
        ...
        private void btnDatHang_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                transactionDB.InsertTransaction(ref err, user.us_username, user.us_address, user.us_phone, dateNow, txtNote.Text);
                ...
                for (int i = dgvGioHang.Rows.Count - 1; i >= 0; i--)
                {
                    ...
                    if (Convert.ToBoolean(row.Cells["Selected"].Value) == true)
                    {
                        ...
                        order.or_quantity = Convert.ToInt32(row.Cells["SoLuong"].Value);
