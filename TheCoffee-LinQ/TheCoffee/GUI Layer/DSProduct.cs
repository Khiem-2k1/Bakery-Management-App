    ...
    public partial class DSProduct : UserControl
    {
        ...
        private void LoadData()
        {
            ...
            var spQuery = (from p in coffe.Products
                           ...
                           where p.categoriesID == c.id && p.supplierID == s.id 
                           select new
                           {
                               p.id,
                               p.pro_name,
            ...
            ccbCategories.DataSource = cQuery;
            ...
            //l?y ID và Tên nhà cung cấp dưới dạn bảng vào ccbSuplier rồi gán giá trị vào các thuộc tính tương ứng
            ccbSupplier.DataSource = sQuery;
        ...
        private void buttonDel_Click(object sender, EventArgs e)
        {
            ...
            try//b?t l?i n?u có
            {
                ...
                if (!dbProduct.deleteProduct(ref err, pro_id))//n?u ko th? xóa product thì s? hi?n ra l?i
                    MessageBox.Show("Lỗi! Không thể xóa sản phẩm", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                else
                {//Xoa thành công s? hi?n thông báo thành công và loaddata
                    MessageBox.Show("Xoá sản phẩmm thành công", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    LoadData();
                }
            }
            catch (Exception)
